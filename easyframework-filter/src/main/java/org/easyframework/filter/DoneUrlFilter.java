...
public class DoneUrlFilter implements Filter {
	private static final Logger log = Logger.getLogger(DoneUrlFilter.class);
	 ...
	 * ||uri.endsWith(".png") ||uri.endsWith(".gif") ||uri.endsWith("index.jsp")
	 * ||uri.endsWith("login.htm") ||uri.endsWith("login.jsp")
	 * 
	 */
