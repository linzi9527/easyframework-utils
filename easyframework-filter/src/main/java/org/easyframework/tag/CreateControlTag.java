...
public class CreateControlTag extends TagSupport {

	/**
	 * 通过自定义权限控制标签，来控制页面相关操作的显示
	 * 添加按钮
	 */
	private static final Logger log = Logger.getLogger(CreateControlTag.class);
